...
const Hero = () => {
  ...
  return (
    <div className="container h-screen mp-default">
      ...
      {/* Text container */}
      <motion.div
        className="text-rose w-full h-full flex flex-col justify-center gap-4"
        initial="initial"
      ...
      >
        ...
        <motion.h1
          className="rounded-text-bg text-5xl lg:text-7xl"
          variants={textVariants}
        >
          Brew 'n Bubble
        </motion.h1>
        ...
        <motion.div
          className="rounded-text-bg bg-rose text-forest text-lg lg:text-2xl font-bold"
          variants={textVariants}
